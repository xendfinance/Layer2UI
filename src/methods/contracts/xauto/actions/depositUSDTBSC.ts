...
import DepositSavingsUSDTBSCXAuto from "../methods/depositUSDTBSCXAuto";


function DepositUSDTBSCXAuto(amount: any, addressOwner: string, chainId: any) {
    return async (dispatch: Function) => {

        try {
            notify('success', 'USDC BSC Deposit Initiated');
            // dispatch(loader(id));
            const response = await DepositSavingsUSDTBSCXAuto(amount, addressOwner, chainId);
...
export default DepositUSDTBSCXAuto;