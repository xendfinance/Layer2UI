...
import WithdrawSavingsWBTCMatic from "../methods/withdrawWBTCMaticXAuto";


function WithdrawWBTCMatic(amount: any,addressOwner:string,chainId:any) {
    return async (dispatch: Function) => {
        
        try {
            notify('success', 'USDT Matic Deposit Initiated');
           // dispatch(loader(id));
            const response = await WithdrawSavingsWBTCMatic(amount,addressOwner,chainId);
...
export default WithdrawWBTCMatic;